# Transfer of meter readings to Tatenergosbyt
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/Gin-dev-code/hass-my-device?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=hass-my-device&category=integration)
...
1. Download the `custom_components/trans_met_read/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=trans_met_read)
...
3. Search for "Transfer of meter readings to Tatenergosbyt"
...
1. Go to **Settings** → **Devices & Services**
2. Find **Transfer of meter readings to Tatenergosbyt**
...
Find all entities in **Settings** → **Devices & Services** → **Transfer of meter readings to Tatenergosbyt** → click on the device.
...
```yaml
service: trans_met_read.example_action
data:
...
logger:
  default: info
  logs:
    custom_components.trans_met_read: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Transfer of meter readings to Tatenergosbyt → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@Gin-dev-code][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/Gin-dev-code/hass-my-device.svg?style=for-the-badge
[commits]: https://github.com/Gin-dev-code/hass-my-device/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/Gin-dev-code/hass-my-device.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40Gin-dev-code-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/Gin-dev-code/hass-my-device.svg?style=for-the-badge
[releases]: https://github.com/Gin-dev-code/hass-my-device/releases
