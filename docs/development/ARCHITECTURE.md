...
This document describes the technical architecture of the Transfer of meter readings to Tatenergosbyt custom component for Home Assistant.

## Directory Structure

```text
custom_components/trans_met_read/
...
│   ├── __init__.py          # Exports TransferOfMeterReadingsToTatenergosbytDataUpdateCoordinator
...
│   ├── __init__.py          # Exports TransferOfMeterReadingsToTatenergosbytEntity
...
- `base.py` - Main coordinator class (`TransferOfMeterReadingsToTatenergosbytDataUpdateCoordinator`)
...
**Key class:** `TransferOfMeterReadingsToTatenergosbytDataUpdateCoordinator` (exported from `coordinator/__init__.py`)
...
**Key class:** `TransferOfMeterReadingsToTatenergosbytApiClient`
...
- `TransferOfMeterReadingsToTatenergosbytConfigFlowHandler` (main flow)
- `TransferOfMeterReadingsToTatenergosbytOptionsFlow` (options)
...
**Key class:** `TransferOfMeterReadingsToTatenergosbytEntity` (in `entity/base.py`)
...
2. `TransferOfMeterReadingsToTatenergosbytEntity` for common functionality
...
1. Create directory: `custom_components/trans_met_read/<platform>/`
2. Implement `__init__.py` with `async_setup_entry()`
3. Create entity classes inheriting from platform base + `TransferOfMeterReadingsToTatenergosbytEntity`
