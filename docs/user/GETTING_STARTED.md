# Getting Started with Transfer of meter readings to Tatenergosbyt

This guide will help you install and set up the Transfer of meter readings to Tatenergosbyt custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Gin-dev-code/hass-my-device`
6. Set category to "Integration"
7. Click "Add"
8. Find "Transfer of meter readings to Tatenergosbyt" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Gin-dev-code/hass-my-device/releases)
2. Extract the `trans_met_read` folder from the archive
3. Copy it to `custom_components/trans_met_read/` in your Home Assistant configuration directory
...
4. Select entities from "Transfer of meter readings to Tatenergosbyt"
...
- Report issues at [GitHub Issues](https://github.com/Gin-dev-code/hass-my-device/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Gin-dev-code/hass-my-device/discussions)
