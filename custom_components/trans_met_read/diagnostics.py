"""Diagnostics support for trans_met_read.
...
if TYPE_CHECKING:
    ...
    from .data import TransferOfMeterReadingsToTatenergosbytConfigEntry
...
async def async_get_config_entry_diagnostics(
    hass: HomeAssistant,
    entry: TransferOfMeterReadingsToTatenergosbytConfigEntry,
) -> dict[str, Any]:
