...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `TransferOfMeterReadingsToTatenergosbyt`
...
- Inherit from both platform entity and `TransferOfMeterReadingsToTatenergosbytEntity` (order matters)
...
from custom_components.trans_met_read.sensor import async_setup_entry
...
**Config entry data:** `entry_data: TransferOfMeterReadingsToTatenergosbytData = hass.data[DOMAIN][entry.entry_id]`
