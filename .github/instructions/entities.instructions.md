...
- **`entity/`** - Base entity classes (inherit `TransferOfMeterReadingsToTatenergosbytEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, TransferOfMeterReadingsToTatenergosbytEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import TransferOfMeterReadingsToTatenergosbytEntity`
