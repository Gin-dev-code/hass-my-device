...
**Applies to:** `custom_components/trans_met_read/manifest.json`
...
```json
{
  ...
  "codeowners": ["@Gin-dev-code"],
  "config_flow": true,
  "documentation": "https://github.com/Gin-dev-code/hass-my-device",
  "integration_type": "device",
  "iot_class": "cloud_polling",
  "issue_tracker": "https://github.com/Gin-dev-code/hass-my-device/issues",
  "requirements": [],
  "version": "0.0.0"
}
```
