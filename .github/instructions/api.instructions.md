...
- `TransferOfMeterReadingsToTatenergosbytApiClientError` (Base)
- `TransferOfMeterReadingsToTatenergosbytApiClientCommunicationError` (Network, timeout, HTTP errors)
- `TransferOfMeterReadingsToTatenergosbytApiClientAuthenticationError` (401, 403, invalid credentials)
