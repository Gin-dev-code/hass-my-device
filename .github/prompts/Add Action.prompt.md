...
**File:** `custom_components/trans_met_read/services.yaml`
...
Create `custom_components/trans_met_read/service_actions/[action_name].py`:

```python
"""[Action name] service action for Transfer of meter readings to Tatenergosbyt."""
...
**File:** `custom_components/trans_met_read/__init__.py`
...
**File:** `custom_components/trans_met_read/const.py`
...
3. Find service action: `trans_met_read.[action_name]`
...
- **Service actions directory:** `custom_components/trans_met_read/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/trans_met_read/services.yaml` (legacy filename)
- **Icons:** `custom_components/trans_met_read/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/trans_met_read/translations/*.json` under `services` key (legacy)
