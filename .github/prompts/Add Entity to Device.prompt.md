...
- Inherit from `TransferOfMeterReadingsToTatenergosbytEntity` and platform base class
...
- Entity: `custom_components/trans_met_read/[platform]/[entity_name].py`
- Platform: `custom_components/trans_met_read/[platform]/__init__.py`
