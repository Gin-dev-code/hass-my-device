...
**Directory:** `custom_components/trans_met_read/[platform]/`
...
```python
"""[Platform] platform for Transfer of meter readings to Tatenergosbyt."""
...
from .entity import TransferOfMeterReadingsToTatenergosbytEntity
from .[entity_file] import TransferOfMeterReadingsToTatenergosbyt[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: TransferOfMeterReadingsToTatenergosbytDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            TransferOfMeterReadingsToTatenergosbyt[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Transfer of meter readings to Tatenergosbyt."""
...
class TransferOfMeterReadingsToTatenergosbyt[EntityName](
    TransferOfMeterReadingsToTatenergosbytEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/trans_met_read/manifest.json`:
...
- [ ] Entity class inherits from both `TransferOfMeterReadingsToTatenergosbytEntity` and platform class
...
- **Base entity:** `TransferOfMeterReadingsToTatenergosbytEntity` in `entity/base.py`
- **Coordinator:** `TransferOfMeterReadingsToTatenergosbytDataUpdateCoordinator`
