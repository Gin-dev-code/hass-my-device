...
- [ ] Entities inherit from both platform base and `TransferOfMeterReadingsToTatenergosbytEntity`
...
- [ ] Classes use `PascalCase` with `TransferOfMeterReadingsToTatenergosbyt` prefix
