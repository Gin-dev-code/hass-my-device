...
- Create new sensor file in `custom_components/trans_met_read/sensor/`
- Inherit from `TransferOfMeterReadingsToTatenergosbytEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Transfer of meter readings to Tatenergosbyt."""
...
class TransferOfMeterReadingsToTatenergosbyt[SensorName]Sensor(
...
- Entity: `custom_components/trans_met_read/sensor/[sensor_name].py`
- Platform: `custom_components/trans_met_read/sensor/__init__.py`
- Translations: `custom_components/trans_met_read/translations/*.json`
