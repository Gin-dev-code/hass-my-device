...
- **Main code:** `custom_components/trans_met_read/`
...
- `entity/` — Base entity class (`TransferOfMeterReadingsToTatenergosbytEntity`)
...
- Entity MRO: `(PlatformEntity, TransferOfMeterReadingsToTatenergosbytEntity)` — order matters
...
- Debug level: `custom_components.trans_met_read: debug` in `config/configuration.yaml`
